...
BUCKET_NAME = 'wagon-data-745-daniel-1'  # ⚠️ replace with your BUCKET NAME
...
def download_model(bucket=BUCKET_NAME,
    ...
    storage_location = f'{BUCKET_NAME}/models/model.jobib'
...
if __name__ == '__main__':
    ...
    get_test_data(nrows, data="s3")
    download_model(bucket=BUCKET_NAME, rm=True)
    get_model(path_to_joblib)
    evaluate_model()
